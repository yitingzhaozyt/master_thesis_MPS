...
function biobjective_product_production()
    model = SDDP.LinearPolicyGraph(;
        ...
        # For each resource, the total production over all products cannot exceed its capacity.
        for r in resources
...
display(p1)
Plots.savefig(p1, "model4_weights_cost_to_go.png")
