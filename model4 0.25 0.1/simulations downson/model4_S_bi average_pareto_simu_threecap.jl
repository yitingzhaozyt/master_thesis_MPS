...
p1 = Plots.plot(lambdas, V1K,
    ...
    yformatter = :plain,)
display(p1)
Plots.savefig(p1, "model4_weights_cost_to_go_low.png")
...
display(plot_cost)
Plots.savefig(plot_cost, "model4_biobjective_simulation_weighted_vs_global_total_cost_low.png")

display(plot_carbon)
Plots.savefig(plot_carbon, "model4_biobjective_simulation_weighted_vs_global_total_carbon_low.png")
...
savefig(carbon_vs_cost_plot, "model4_carbon_vs_cost_by_lambda_low.png")
